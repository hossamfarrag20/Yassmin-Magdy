  ...
  return (
    ...
    >
      <img
        ...
        alt="Brush"
        loading="lazy"
        className="w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 opacity-90 filter drop-shadow-2xl"
        style={{
          filter:
      ...
      <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2">
        <div className="w-3 h-24 md:w-4 md:h-32 lg:w-5 lg:h-40 bg-gradient-to-b from-primary/40 dark:from-primary/60 to-transparent rounded-full animate-pulse" />
      </div>
    </div>
  );
}
